...
public class MutipleInputAugmentor {
     ...
     */
    public static void run(ArgumentHandler argsH,
                           String inputFile,
    ...
    private static IIteratingChemObjectReader<IAtomContainer> getInputReader(
        ...
        switch (inputFormat) {
            case SMILES:
                reader = new IteratingSMILESReader(in, builder);
                break;
            case SIGNATURE:
                reader = new IteratingSignatureReader(in, builder);
                break;
            case SDF:
                throw new UnsupportedOperationException("Fix This"); // ToDo
               // reader = new IteratingSDFReader(in, builder);
               // break;
            case ACP:
                reader = new IteratingACPReader(in, builder);
                break;
            default:
                reader = null;
