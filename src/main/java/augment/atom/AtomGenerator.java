...
public class AtomGenerator implements AugmentingGenerator {
    ...
    public static void showArrayAndIndex(int index, List<Augmentation<IAtomContainer, AtomExtension>> augment) {
        System.out.println("==== " + index + " ===================");
        for (Augmentation<IAtomContainer, AtomExtension> aa : augment) {
    ...
    public static void showValueAndIndex(int index, Augmentation<IAtomContainer, AtomExtension> aa, boolean handled) {
        if(!handled)
            return;
