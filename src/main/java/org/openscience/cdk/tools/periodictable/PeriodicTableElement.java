...
class PeriodicTableElement implements Cloneable
{
	...
	*/
     ...
     */
    protected Double vdwRadius = 0.0; // (Double)CDKConstants.UNSET;   changeed SLewis to make 1.4.9 ok

    /**
     * The covalent radius of the element.
     */
    protected Double covalentRadius = 0.0; // (Double)CDKConstants.UNSET;   changeed SLewis to make 1.4.9 ok

    /**
     * The Pauling electronegativity of the element.
     */
    protected Double paulingEneg = 0.0; // (Double)CDKConstants.UNSET;       changeed SLewis to make 1.4.9 ok

    /**
     * The atomic number of the element.
     */
    private Integer atomicNumber = (Integer)0; // CDKConstants.UNSET;     changeed SLewis to make 1.4.9 ok
