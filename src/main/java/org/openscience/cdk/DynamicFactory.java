 ...
 * @cdk.githash
 */
public class DynamicFactory  implements Serializable {
    ...
    /**
      * Inspects whether the provided class is a Serializable
      *
      * @param c class to test
      * @return whether the class is concrete
      */
     private boolean isSerializable(Class<?> c) {
         return c.isInstance(Serializable.class);
     }
    ...
    //    if(!isSerializable(impl))
     //       throw new IllegalArgumentException("attempt to register non-serializable class");
     ...
     * constructors easier.
     */
    private static class ConstructorLookup implements  Serializable {
     ...
     */
    public static abstract class ConstructorKey implements Comparable<ConstructorKey>,Serializable {
     ...
     */
    public static interface InterfaceProvider extends Serializable {
     ...
     */
    public static interface CreationModifier<T> extends Serializable {
     ...
     * @param <T> the type of object that will be created
     */
    public static interface Creator<T> extends Serializable {
