...
public class SimpleLibraryBuilder {
 ...
 //        SparkMapReduce handler = new SparkMapReduce(new WordCountMapper(),new WordCountReducer(),IPartitionFunction.HASH_PARTITION,consumer);
        ...
        String name = "Null Mapper";
        NullStringMapper nullStringMapper = new NullStringMapper();
        NullStringReducer nullStringReducer = new NullStringReducer();
        SparkMapReduce handler = new SparkMapReduce(name, nullStringMapper,
                nullStringReducer,IPartitionFunction.HASH_PARTITION,consumer );
