...
public class BondAugmentingGeneratorTest extends BaseTest {
    ...
    public void countC4H6FromSDT() {
        int count = countNFromSingleDoubleTriple("C4H6", null, null, null, AugmentationMethod.BOND);
        System.out.println(count);
    }
    
    @Test
    public void countC5H10FromSDT() {
        int count = countNFromSingleDoubleTriple("C5H10", null, null, null, AugmentationMethod.BOND);
        System.out.println(count);
    }
